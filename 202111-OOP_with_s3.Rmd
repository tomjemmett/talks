...
ic <- list()
ic$em <- icons::icon_find("envelope")[[1]]
...
@strategy_unit [`r ic$de`][su_web] / [`r ic$em`][su_email] / [`r ic$tw`][su_twitter] / [`r ic$gh`][su_github] /
[`r ic$li`][su_linkedin]
]
...
`r ic$em` [thomas.jemmett@nhs.net][tj_email]
...
- @tomjemmett [`r ic$tw`][tj_twitter] / [`r ic$gh`][tj_github] / [`r ic$li`][tj_linkedin]
]
...
print.about_me <- function(x, ...) {
  cat("My name is ", x$name, ", and I work for ", x$works_for, ".", sep = "")
  cat("My favourite food is", x$favourite_food, "\n")
}
